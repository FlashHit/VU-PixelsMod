...
Events:Subscribe('Partition:Loaded', function(partition)
    ...
    if (bEnable_announcement) == (true) then dprint("Engineer: Removing recoil for A91 ...") 
...
Events:Subscribe('Partition:Loaded', function(partition)
	...
	for _, instance in pairs(instances) do
		...
		if instance.instanceGuid == Guid('B22D635A-8AD5-4A18-9F8E-CA3B03CD09EA') then
			...
			gunSwayData.shootingRecoilDecreaseScale = 0
			gunSwayData.firstShotRecoilMultiplier = 0
    if (bEnable_announcement) == (true) then dprint("Engineer: Removing recoil for AKS74U ...") 
...
Events:Subscribe('Partition:Loaded', function(partition)
	...
	for _, instance in pairs(instances) do
		...
		if instance.instanceGuid == Guid('B3B20511-2AD1-44FA-9BD3-0C806E3F439F') then
			...
			gunSwayData.shootingRecoilDecreaseScale = 0
			gunSwayData.firstShotRecoilMultiplier = 0
    if (bEnable_announcement) == (true) then dprint("Engineer: Removing recoil for G36C ...") 
...
Events:Subscribe('Partition:Loaded', function(partition)
	...
	for _, instance in pairs(instances) do
		...
		if instance.instanceGuid == Guid('73D73EFD-F082-4C13-8253-24E4FEB39244') then
			...
			gunSwayData.shootingRecoilDecreaseScale = 0
			gunSwayData.firstShotRecoilMultiplier = 0
    if (bEnable_announcement) == (true) then dprint("Engineer: Removing recoil for M4 / M4A1 ...") 
...
Events:Subscribe('Partition:Loaded', function(partition)
	...
	for _, instance in pairs(instances) do
		...
		if instance.instanceGuid == Guid('A80FD0C6-ABAA-40E5-8B00-B1E22B336C69') then
			...
			gunSwayData.shootingRecoilDecreaseScale = 0
			gunSwayData.firstShotRecoilMultiplier = 0
    if (bEnable_announcement) == (true) then dprint("Engineer: Removing recoil for SCAR-H ...") 
...
Events:Subscribe('Partition:Loaded', function(partition)
	...
	for _, instance in pairs(instances) do
		...
		if instance.instanceGuid == Guid('21076244-C5A8-465C-862E-318F7AB2B093') then
			...
			gunSwayData.shootingRecoilDecreaseScale = 0
			gunSwayData.firstShotRecoilMultiplier = 0
    if (bEnable_announcement) == (true) then dprint("Engineer: Removing recoil for SG553LB ...") 
...
Events:Subscribe('Partition:Loaded', function(partition)
	...
	for _, instance in pairs(instances) do
		...
		if instance.instanceGuid == Guid('FAF319AB-A9A8-420E-A7BB-E3093C9A3FC7') then
			...
			gunSwayData.shootingRecoilDecreaseScale = 0
			gunSwayData.firstShotRecoilMultiplier = 0
    if (bEnable_announcement) == (true) then dprint("Engineer: Removing recoil for HK53 ...") 
...
Events:Subscribe('Partition:Loaded', function(partition)
	...
	for _, instance in pairs(instances) do
		...
		if instance.instanceGuid == Guid('0FB26814-4C69-4823-A8C9-54A84D633469') then
			...
			gunSwayData.shootingRecoilDecreaseScale = 0
			gunSwayData.firstShotRecoilMultiplier = 0
    if (bEnable_announcement) == (true) then dprint("Engineer: Removing recoil for QBZ95B ...") 
...
Events:Subscribe('Partition:Loaded', function(partition)
	...
	for _, instance in pairs(instances) do
		...
		if instance.instanceGuid == Guid('24C58B0A-7349-46E2-AFE9-45C52B4D34EF') then
			...
			gunSwayData.shootingRecoilDecreaseScale = 0
			gunSwayData.firstShotRecoilMultiplier = 0
    if (bEnable_announcement) == (true) then dprint("Engineer: Removing recoil for ACWR ...") 
...
Events:Subscribe('Partition:Loaded', function(partition)
	...
	for _, instance in pairs(instances) do
		...
		if instance.instanceGuid == Guid('80F4E593-17B4-4EB8-BECB-EE5C603049FB') then
			...
			gunSwayData.shootingRecoilDecreaseScale = 0
			gunSwayData.firstShotRecoilMultiplier = 0
    if (bEnable_announcement) == (true) then dprint("Engineer: Removing recoil for MTAR ...") 
