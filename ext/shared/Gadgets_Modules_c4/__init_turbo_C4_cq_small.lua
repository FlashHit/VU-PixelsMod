...
ResourceManager:RegisterInstanceLoadHandler(partition_c4exp, instance_c4exp, function(loadedInstance)
	...
	print('Changed Gadgets: More damage on C4 Explosion - Conquest Small ...')
	end)
...
ResourceManager:RegisterInstanceLoadHandler(partition_c4, instance_c4, function(loadedInstance)
	...
	print('Changed Gadgets: Turbo C4 - Increased AMMO size - Conquest Small ...')
	end)
	...
	print('Changed Gadgets: Turbo C4 - Conquest Small - can place more !...')
	end)
end
end)
