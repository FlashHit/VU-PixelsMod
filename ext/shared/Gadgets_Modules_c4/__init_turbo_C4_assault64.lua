...
ResourceManager:RegisterInstanceLoadHandler(partition_c4exp, instance_c4exp, function(loadedInstance)
	...
	print('Changed Gadgets: More damage on C4 Explosion - Conquest Assault Large ...')
	end)

Events:Subscribe('Level:LoadResources', function()

	if SharedUtils:GetCurrentGameMode() == "ConquestAssaultLarge0" then
ResourceManager:RegisterInstanceLoadHandler(partition_c4, instance_c4, function(loadedInstance)
	...
	print('Changed Gadgets: Turbo C4 - Increased AMMO size - Conquest Assault Large ...')
	end)
	...
	print('Changed Gadgets: Turbo C4 - Conquest Assault Large - can place more !...')
	end)
end
end)
