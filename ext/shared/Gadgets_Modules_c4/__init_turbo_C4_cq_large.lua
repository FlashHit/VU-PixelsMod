...
ResourceManager:RegisterInstanceLoadHandler(partition_c4exp, instance_c4exp, function(loadedInstance)
	...
	print('Changed Gadgets: More damage on C4 Explosion - Conquest Large...')
	end)
...
ResourceManager:RegisterInstanceLoadHandler(partition_c4, instance_c4, function(loadedInstance)
	...
	print('Changed Gadgets: Turbo C4 - Increased AMMO size - Conquest Large...')
	end)
	...
	print('Changed Gadgets: Turbo C4 - Conquest Large - can place more !...')
	end)
end
end)
