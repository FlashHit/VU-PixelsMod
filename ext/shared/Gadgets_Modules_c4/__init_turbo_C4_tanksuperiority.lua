...
ResourceManager:RegisterInstanceLoadHandler(partition_c4exp, instance_c4exp, function(loadedInstance)
	...
	print('Changed Gadgets: More damage on C4 Explosion - Tank Superiority ...')
	end)
...
ResourceManager:RegisterInstanceLoadHandler(partition_c4, instance_c4, function(loadedInstance)
	...
	print('Changed Gadgets: Turbo C4 - Increased AMMO size - Tank Superiority ...')
	end)
	...
	print('Changed Gadgets: Turbo C4 - Tank Superiority - can place more !...')
	end)
end
end)
