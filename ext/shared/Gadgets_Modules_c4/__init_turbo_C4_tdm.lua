...
ResourceManager:RegisterInstanceLoadHandler(partition_c4exp, instance_c4exp, function(loadedInstance)
	...
	print('Changed Gadgets: More damage on C4 Explosion - Team DeathMatch...')
	end)

Events:Subscribe('Level:LoadResources', function()

	if SharedUtils:GetCurrentGameMode() == "TeamDeathMatch0" then
ResourceManager:RegisterInstanceLoadHandler(partition_c4, instance_c4, function(loadedInstance)
	...
	print('Changed Gadgets: Turbo C4 - Increased AMMO size - Team DeathMatch ...')
	end)
	...
	print('Changed Gadgets: Turbo C4 - Team DeathMatch - can place more !...')
	end)
end
end)
