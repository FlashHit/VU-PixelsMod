class "MMHandgun_M93r"

function MMHandgun_M93r:Write(instance)
...
--		self:OverrideGMMagSize(weaponData, 5)
		...
		dprint('Changed M93r - Unlimited ammo...')
	end 
...
--		self:OverrideGMMagSize(weaponData, 5)
		...
		bulletData.damageFalloffStartDistance = 0
		bulletData.damageFalloffEndDistance = 1
		dprint('Changed M93r (GM) Unlimited ammo...')
	end 

end
return MMHandgun_M93r()
